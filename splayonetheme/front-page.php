    ...
    <section>
        <div class="page_container top_page_padding">
            ...
            $news_args = array(
                ...
                'posts_per_page' => 4, // Retrieve only 4 posts
                'meta_query' => array(
                    array(
            ...
            if ($news_query->have_posts()) {
                ...
                <div class="content padding_bottom_sm">
                    ...
                    <div class="news_scrool_feed in_home_ padding_bottom_sm">
                        <?php
                            ...
                            ?>
                                <div class="news_item news_item_mobile">
                                    ...
                                    <div class="front_page">
                                        <div>
                                            <p class="font-weight-bold adieu_black text_2"><?php echo $formatted_date; ?></p>
